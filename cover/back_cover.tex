...
\begin{tikzpicture}[remember picture,overlay]
\shade [bottom color=blue!50!black,top color=blue!70!black!50]
...
%\node[yshift=7cm,scale=2,blue!30!black] at (current page.center) {\Huge \textsc{Fundamentals}};
%\node[yshift=4cm,scale=2,blue!30!black] at (current page.center) {\Huge \textsc{Matrix Algebra}};
...
\draw (0in,-8in) node [scale=1,white] {Prepared for the use of the};
\draw (0in,-8.25in) node [scale=1,white] {Cadets of the Virginia Military Institute};
