...
\definition{def:lin_trans}{\textbf{Linear Transformation}\\
...
\definition{def:standard_matrix}{\textbf{Standard Matrix of a Linear Transformation}\\
...
\keyidea{idea:transform_zero}{\textbf{Linear Transformations and \zero}\\
...
\definition{def:standard_unit}{\textbf{Standard Unit Vectors}\\
...
\theorem{thm:standard_matrix}{\textbf{The Standard Matrix of a Linear Transformation}\\
...
\keyidea{idea:when_linear}{\textbf{Conditions on Linear Transformations}\\
